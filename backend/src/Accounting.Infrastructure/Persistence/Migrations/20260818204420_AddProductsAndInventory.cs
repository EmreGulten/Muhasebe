...
namespace Accounting.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddProductsAndInventory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_TenantId_ProductId_Date",
                table: "InventoryTransactions",
                columns: new[] { "TenantId", "ProductId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_TenantId_ReferenceType_ReferenceId",
                table: "InventoryTransactions",
                columns: new[] { "TenantId", "ReferenceType", "ReferenceId" });

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_TenantId_WarehouseId",
                table: "InventoryTransactions",
